 ...
 * generated in the soen487.g4.sc.manufacturer.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessPurchaseOrderResponse_QNAME = new QName("http://service.manufacturer.sc.g4.soen487/", "processPurchaseOrderResponse");
    private final static QName _GetProductInfoResponse_QNAME = new QName("http://service.manufacturer.sc.g4.soen487/", "getProductInfoResponse");
    private final static QName _ReceivePayment_QNAME = new QName("http://service.manufacturer.sc.g4.soen487/", "receivePayment");
    private final static QName _ReceivePaymentResponse_QNAME = new QName("http://service.manufacturer.sc.g4.soen487/", "receivePaymentResponse");
    private final static QName _GetProductInfo_QNAME = new QName("http://service.manufacturer.sc.g4.soen487/", "getProductInfo");
    private final static QName _ProcessPurchaseOrder_QNAME = new QName("http://service.manufacturer.sc.g4.soen487/", "processPurchaseOrder");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soen487.g4.sc.manufacturer.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.manufacturer.sc.g4.soen487/", name = "processPurchaseOrderResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.manufacturer.sc.g4.soen487/", name = "getProductInfoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.manufacturer.sc.g4.soen487/", name = "receivePayment")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.manufacturer.sc.g4.soen487/", name = "receivePaymentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.manufacturer.sc.g4.soen487/", name = "getProductInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.manufacturer.sc.g4.soen487/", name = "processPurchaseOrder")
